...
cd ${EDGEFLOWERTUNE_ROOT}/operators/build_opt
OUT_GPT2_CPP="${EDGEFLOWERTUNE_ROOT}/runs/gpt2_lora_s128_b8_acc1_e1_lr2e-4"
mkdir -p "$OUT_GPT2_CPP"

./gpt2_lora_finetune \
  --data_dir "${EDGEFLOWERTUNE_ROOT}/data/wikitext2/wikitext-2-raw" \
  --pretrained_dir "${EDGEFLOWERTUNE_ROOT}/gpt2_lora_finetune/pretrained/gpt2" \
...
OUT_GEMMA_CPP="${EDGEFLOWERTUNE_ROOT}/runs/gemma_lora_s128_b8_acc1_50p"
mkdir -p "$OUT_GEMMA_CPP"

./train_lora_gemma \
  --model_dir "${EDGEFLOWERTUNE_ROOT}/gemma-3-270m" \
  --pretokenized_path "${EDGEFLOWERTUNE_ROOT}/data/wikitext2/pretokenized_gemma/wt2_gemma_tokens.bin" \
  --pretokenized_meta "${EDGEFLOWERTUNE_ROOT}/data/wikitext2/pretokenized_gemma/meta.json" \
...
OUT_GPT2_PT="${EDGEFLOWERTUNE_ROOT}/runs/gpt2_lora_pt_s128_b8_acc1_e1_lr2e-4"
mkdir -p "$OUT_GPT2_PT"
...
OUT_GEMMA_PT="${EDGEFLOWERTUNE_ROOT}/runs/gemma_lora_pt_s128_b8_acc1_50p"
