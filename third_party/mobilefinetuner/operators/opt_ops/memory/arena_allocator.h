 ...
 * @brief Partitioned memory manager - prevents linear physical footprint growth
 */
...
public:
    ...
    void reset();
    void recreate();  // Generation-based arena rebuild: fully recreate and reset the virtual address space.
...
public:
    ...
    // Generation-based arena rebuild to prevent macOS physical footprint accumulation.
    void regenerate() {
        arena_.recreate();
    }
